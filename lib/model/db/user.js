    ...
    'User',
    {
      ...
      start_date: {
        ...
        get: function() {
          ...
          const dateMoment = moment.utc(startDate)
          // Check if moment object is valid before formatting
          if (!dateMoment.isValid()) {
            console.warn('Invalid start_date value for user:', this.id, startDate)
            return null
          }
      ...
      end_date: {
        ...
        get: function() {
          ...
          const dateMoment = moment.utc(endDate)
          // Check if moment object is valid before formatting
          if (!dateMoment.isValid()) {
            console.warn('Invalid end_date value for user:', this.id, endDate)
            return null
          }
