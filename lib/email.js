...
const transporter = nodemailer.createTransport(
  smtpTransport({
    ...
    requireTLS: smtpConfig.requireTLS !== undefined ? smtpConfig.requireTLS : false,
    ignoreTLS: smtpConfig.ignoreTLS !== undefined ? smtpConfig.ignoreTLS : false,
    auth: smtpConfig.auth && smtpConfig.auth.user ? smtpConfig.auth : false,
    tls: smtpConfig.tls || {
      rejectUnauthorized: smtpConfig.tls && smtpConfig.tls.rejectUnauthorized !== undefined
