...
nconf
  ...
  .defaults({
    ...
    smtp: {
      ...
      secure: false, // Set to true for TLS/SSL connections (port 465)
      requireTLS: false, // Set to true to require TLS upgrade via STARTTLS
      ignoreTLS: false, // Set to true to ignore STARTTLS (don't upgrade to TLS)
      tls: {
